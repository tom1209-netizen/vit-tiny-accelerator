...
/* Target image size (ViT Input Size) */
#define TARGET_WIDTH        224
#define TARGET_HEIGHT       224

#define IMG_POS_Y            248 // pixel cordinate
...
#define RX_BUFFER_BASE      (XPAR_PS7_DDR_0_BASEADDRESS + 0x00300000) // a address space to get data from dma for testing
#define TEST_PKT_LEN_BYTES  80  // Test với 1KB trước


#define DDR_BASE_TEXT_FROM_VIT  (XPAR_PS7_DDR_0_BASEADDRESS + 0x12000000) // address space to get text data from ViT
