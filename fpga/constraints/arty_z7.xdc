...
## Constrain high-fanout control nets to encourage replication/buffering
set_max_fanout 24 [get_nets {stall_if stall_id stall_ex flush_id flush_ex pc_src_d_reg* pc_out_reg*}]
...
## Buttons
#set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { rst_n }]; #IO_L4P_T0_35 Sch=BTN0
