...
module output_collector #(
    ...
    // Verilog-2001 function to select a value by (row, col)
    function [ACC_WIDTH-1:0] get_acc;
        ...
        begin
            case (r)
            4'd0: case (c)
                4'd0: get_acc = acc_in_0_0; 4'd1: get_acc = acc_in_0_1;
                4'd2: get_acc = acc_in_0_2; 4'd3: get_acc = acc_in_0_3;
                4'd4: get_acc = acc_in_0_4; 4'd5: get_acc = acc_in_0_5;
                4'd6: get_acc = acc_in_0_6; 4'd7: get_acc = acc_in_0_7;
                default: get_acc = {ACC_WIDTH{1'b0}};
            endcase
            4'd1: case (c)
                4'd0: get_acc = acc_in_1_0; 4'd1: get_acc = acc_in_1_1;
                4'd2: get_acc = acc_in_1_2; 4'd3: get_acc = acc_in_1_3;
                4'd4: get_acc = acc_in_1_4; 4'd5: get_acc = acc_in_1_5;
                4'd6: get_acc = acc_in_1_6; 4'd7: get_acc = acc_in_1_7;
                default: get_acc = {ACC_WIDTH{1'b0}};
            endcase
            4'd2: case (c)
                4'd0: get_acc = acc_in_2_0; 4'd1: get_acc = acc_in_2_1;
                4'd2: get_acc = acc_in_2_2; 4'd3: get_acc = acc_in_2_3;
                4'd4: get_acc = acc_in_2_4; 4'd5: get_acc = acc_in_2_5;
                4'd6: get_acc = acc_in_2_6; 4'd7: get_acc = acc_in_2_7;
                default: get_acc = {ACC_WIDTH{1'b0}};
            endcase
            4'd3: case (c)
                4'd0: get_acc = acc_in_3_0; 4'd1: get_acc = acc_in_3_1;
                4'd2: get_acc = acc_in_3_2; 4'd3: get_acc = acc_in_3_3;
                4'd4: get_acc = acc_in_3_4; 4'd5: get_acc = acc_in_3_5;
                4'd6: get_acc = acc_in_3_6; 4'd7: get_acc = acc_in_3_7;
                default: get_acc = {ACC_WIDTH{1'b0}};
            endcase
            4'd4: case (c)
                4'd0: get_acc = acc_in_4_0; 4'd1: get_acc = acc_in_4_1;
                4'd2: get_acc = acc_in_4_2; 4'd3: get_acc = acc_in_4_3;
                4'd4: get_acc = acc_in_4_4; 4'd5: get_acc = acc_in_4_5;
                4'd6: get_acc = acc_in_4_6; 4'd7: get_acc = acc_in_4_7;
                default: get_acc = {ACC_WIDTH{1'b0}};
            endcase
            4'd5: case (c)
                4'd0: get_acc = acc_in_5_0; 4'd1: get_acc = acc_in_5_1;
                4'd2: get_acc = acc_in_5_2; 4'd3: get_acc = acc_in_5_3;
                4'd4: get_acc = acc_in_5_4; 4'd5: get_acc = acc_in_5_5;
                4'd6: get_acc = acc_in_5_6; 4'd7: get_acc = acc_in_5_7;
                default: get_acc = {ACC_WIDTH{1'b0}};
            endcase
            4'd6: case (c)
                4'd0: get_acc = acc_in_6_0; 4'd1: get_acc = acc_in_6_1;
                4'd2: get_acc = acc_in_6_2; 4'd3: get_acc = acc_in_6_3;
                4'd4: get_acc = acc_in_6_4; 4'd5: get_acc = acc_in_6_5;
                4'd6: get_acc = acc_in_6_6; 4'd7: get_acc = acc_in_6_7;
                default: get_acc = {ACC_WIDTH{1'b0}};
            endcase
            4'd7: case (c)
                4'd0: get_acc = acc_in_7_0; 4'd1: get_acc = acc_in_7_1;
                4'd2: get_acc = acc_in_7_2; 4'd3: get_acc = acc_in_7_3;
                4'd4: get_acc = acc_in_7_4; 4'd5: get_acc = acc_in_7_5;
                4'd6: get_acc = acc_in_7_6; 4'd7: get_acc = acc_in_7_7;
                default: get_acc = {ACC_WIDTH{1'b0}};
            endcase
            default: get_acc = {ACC_WIDTH{1'b0}};
            endcase
            ...
            if (active) begin
                ...
                if (!m_axis_tvalid || m_axis_tready) begin
                    if (row_idx < ARRAY_SIZE && col_idx < ARRAY_SIZE) begin
                        ...
                        // Advance indices by VALUES_PER_BEAT (=2)
